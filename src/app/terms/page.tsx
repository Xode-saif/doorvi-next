...
export default function TermsAndCon() {
    return (
        <div className='py-20 max-w-[80%] flex flex-col itmes-center mx-auto '>
            <h1 className="font-semibold text-[55px] leading-15 pb-4">Terms of use</h1>
            <div className="mb-[60px] font-semibold text-[24px]" >
                <h3>End User License Agreement
                </h3>
                <h3>Last Update: March 05, 2023
                </h3>
            </div>
            <p>DoorVi is licensed to You (End-User) by Bolo International Limited, for use only under the terms of this License Agreement.
            </p>
            <br />
            ...
            <br />
            <p>The parties of this License Agreement acknowledge that Apple is not a Party to this License Agreement and is not bound by any provisions or obligations with regard to the Application, such as warranty, liability, maintenance and support thereof. DoorVi, not Apple, is solely responsible for the licensed Application and the content thereof.</p>
            <br />
            <p>This License Agreement may not provide for usage rules for the Application that are in conflict with the latest App Store Terms of Service. DoorVi acknowledges that it had the opportunity to review said terms and this License Agreement is not conflicting with them.</p>
            <br />
            ...
            <br />
            <p>DoorVi (hereinafter: Application) is a piece of software created to Connect visitors with residents using the DoorVi app - and customized for Apple mobile devices. It is used to allow a resident to answer the door from anywhere .</p>
            <br />
            <br />
            ...
            <br />
            <p>2.3 You may not share or make the Application available to third parties (unless to the degree allowed by the Apple Terms and Conditions, and with DoorVi&apos;s prior written consent), sell, rent, lend, lease or otherwise redistribute the Application.</p>
            <br />
            <p>2.4 You may not reverse engineer, translate, disassemble, integrate, decompile, integrate, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Application, or any part thereof (except with DoorVi&apos;s prior written consent).</p>
            <br />
            ...
            <br />
            <p>4.2 DoorVi and the End-User acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the licensed Application.</p>
            <br />
            <br />
            <p>5. USE OF DATA</p>
            <br />
            <p>You acknowledge that Licensor will be able to access and adjust Your downloaded licensed Application content and Your personal information, and that Licensor&apos;s use of such material and information is subject to Your legal agreements with Licensor and Licensor&apos;s privacy policy: __________.</p>
            <br />
            <br />
            ...
            <br />
            <p>9.2 No warranty is provided for the Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of DoorVi&apos;s sphere of influence that affect the executability of the Application.</p>
            <br />
            <p>9.3 You are required to inspect the Application immediately after installing it and notify DoorVi about issues discovered without delay by e-mail provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been mailed within a period of ninety (90) days after discovery.</p>
            <br />
            <p>9.4 If we confirm that the Application is defective, DoorVi reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.</p>
            <br />
            ...
            <br />
            <p>DoorVi and the End-User acknowledge that DoorVi, and not Apple, is responsible for addressing any claims of the End-User or any third party relating to the licensed Application or the End-User’s possession and/or use of that licensed Application, including, but not limited to:</p>
            <br />
            ...
            <br />
            <p>You represent and warrant that You are not located in a country that is subject to a India Government embargo, or that has been designated by the India Government as a &quot;terrorist supporting&quot; country; and that You are not listed on any India Government list of prohibited or restricted parties.</p>
            <br />
            <br />
            ...
            <br />
            <p>DoorVi support</p>
            <p>6 Floor Tower A, Office No 602, The I Thum Tower</p>
            ...
            <p>13. TERMINATION</p>
            <br />
            <p>The license is valid until terminated by DoorVi or by You. Your rights under this license will terminate automatically and without notice from DoorVi if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Application, and destroy all copies, full or partial, of the Application.</p>
            <br />
            <br />
            <p>14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</p>
            <br />
            <p>DoorVi represents and warrants that DoorVi will comply with applicable third-party terms of agreement when using licensed Application.</p>
            <br />
            ...
            <br />
            <p>DoorVi and the End-User acknowledge that, in the event of any third-party claim that the licensed Application or the End-User&apos;s possession and use of that licensed Application infringes on the third party&apos;s intellectual property rights, DoorVi, and not Apple, will be solely responsible for the investigation, defense, settlement and discharge or any such intellectual property infringement claims.</p>
            <br />
            <br />
            16. APPLICABLE LAW
            <br />
            <p>This license agreement is governed by the laws of the India excluding its conflicts of law rules.</p>
            <br />
            <br />
